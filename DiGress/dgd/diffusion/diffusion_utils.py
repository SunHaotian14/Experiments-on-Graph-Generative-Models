...
# if still error, try to use the following line
    # print("=======", probE.size(0), probE.size(1))
    # print("=======", probE)
    # print("+++", probE.multinomial(1))
    # print("+++", node_mask.size(0), node_mask.size(1), node_mask.size(1))
    # Sample E
